...
namespace argos
{
  ...
  CEPuckEntity::CEPuckEntity() : CComposableEntity(NULL),
                                 ...
                                 m_pcRABEquippedEntityDefault(NULL) {}
  ...
  CEPuckEntity::CEPuckEntity(const std::string &str_id,
                             ...
                             Real f_rab_range,
                             size_t un_rab_data_size) : CComposableEntity(NULL, str_id),
                                                        m_pcControllableEntity(NULL),
                                                        m_pcEmbodiedEntity(NULL),
                                                        m_pcGroundSensorEquippedEntity(NULL),
                                                        m_pcLEDEquippedEntity(NULL),
                                                        ...
                                                        m_pcRABEquippedEntityDefault(NULL)
  {
    try
    {
      ...
      AddComponent(*m_pcRABEquippedEntityDefault);
...
#define UPDATE(COMPONENT)     \
  ...
  void CEPuckEntity::UpdateComponents()
  {
    ...
    UPDATE(m_pcRABEquippedEntityDefault);
